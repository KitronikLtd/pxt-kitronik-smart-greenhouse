...
namespace kitronik_ec_board {
     ...
     */
    //% blockId="kitronik_ec_board_buzzer_setup" block="set music pin for buzzer"
    ...
    //% subcategory="ZIP LEDs"
    //% weight=1 blockGap=8
    //% blockId="kitronik_ec_board_wavelength" block="wavelength %wavelength|nm"
    ...
    //% subcategory="ZIP LEDs"
    //% weight=1 blockGap=8
    //% blockId="kitronik_ec_board_hue" block="hue %hue"
    ...
    //% subcategory="ZIP LEDs"
    //% weight=1 blockGap=8
    //% blockId="kitronik_ec_board_rgb" block="red %red|green %green|blue %blue"
    ...
    */
    //% subcategory="ZIP LEDs"
    //% weight=2 blockGap=8
    //% blockId="kitronik_ec_board_colors" block="%color"
    ...
    */
    //% subcategory="Clock"
    //% group="Set Time"
    //% blockId=kitronik_ec_board_set_time 
    ...
    */
    //% subcategory="Clock"
    //% group="Read Time"
    //% blockId=kitronik_ec_board_read_time 
    ...
    */
    //% subcategory="Clock"
    //% group="Set Date"
    //% blockId=kitronik_ec_board_set_date 
    ...
    */
    //% subcategory="Clock"
    //% group="Read Date"
    //% blockId=kitronik_ec_board_read_date 
    ...
    //% subcategory="Clock"
    //% group="Read Time"
    //% blockId=kitronik_ec_board_read_time_parameter 
    ...
    */
    //% subcategory="Clock"
    //% group="Set Time"
    //% blockId=kitronik_ec_board_write_hours 
    ...
    */
    //% subcategory="Clock"
    //% group="Set Time"
    //% blockId=kitronik_ec_board_write_minutes 
    ...
    */
    //% subcategory="Clock"
    //% group="Set Time"
    //% blockId=kitronik_ec_board_write_seconds 
    ...
    //% subcategory="Clock"
    //% group="Read Date"
    //% blockId=kitronik_ec_board_read_date_parameter 
    //% block="Read %selectParameter| as Number"
    ...
    */
    //% subcategory="Clock"
    //% group="Set Date"
    //% blockId=kitronik_ec_board_write_day
    ...
    */
    //% subcategory="Clock"
    //% group="Set Date"
    //% blockId=kitronik_ec_board_write_month 
    ...
    */
    //% subcategory="Clock"
    //% group="Set Date"
    //% blockId=kitronik_ec_board_write_year 
    ...
    */
    //% subcategory="Clock"
    //% group=Alarm
    //% blockId=kitronik_ec_board_simple_set_alarm 
    ...
    //% subcategory="Clock"
    //% group=Alarm
    //% blockId=kitronik_ec_board_on_alarm block="on alarm trigger"
    ...
    */
    //% subcategory="Clock"
    //% group=Alarm
    //% blockId=kitronik_ec_board_simple_check_alarm 
    ...
    */
    //% subcategory="Clock"
    //% group=Alarm
    //% blockId=kitronik_ec_board_alarm_off 
	...
	*/
    ...
    //% block="Read Pressure in %pressure_unit=kitronik_BME280.pressure_units"
    //% weight=85 blockGap=8
    export function pressure(pressure_unit: string): number {
	...
	*/
    ...
    //% block="Read Temperature in %temperature_unit=kitronik_BME280.temperature_units"
    //% weight=80 blockGap=8
    export function temperature(temperature_unit: string): number {
        if (kitronik_BME280.initalised == false)
            kitronik_BME280.secretIncantation()
	...
	*/
    ...
    //% group=Setup
    //% weight=100 blockGap=8
    //% blockId=kitronik_ec_board_output_to_usb
    ...
    //% group=Setup
    //% weight=90 blockGap=8
    //% blockId=kitronik_ec_board_select_separator
    ...
    //% group=Setup
    //% weight=85 blockGap=8
    //% blockId=kitronik_ec_board_entry_numbers
    ...
    //% blockId=kitronik_ec_board_entry_title
    ...
    //% group=Entries
    //% weight=70 blockGap=8
    //% blockId=kitronik_ec_board_clear
    ...
    //% group=Transfer
    //% weight=65 blockGap=8
    //% blockId=kitronik_ec_board_send_all
    ...
    //% group=Transfer
    //% weight=60 blockGap=8
    //% blockId=kitronik_ec_board_send_selected
